                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col text-center">
                            <img src="<?= base_url() ?>assets/img/undraw_ok.png" alt="image-ok" class="img-fluid" width="75%">
                        </div>
                        <div class="col">
                            <h2 class="text-info">Belum ada perkara untuk ditentukan Majelis Hakim. <br> Terimakasih!!</h2>
                        </div>
                    </div>
